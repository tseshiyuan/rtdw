 ...
 * @author : Albin
 */
public class Output implements DataEngineModule, DataEngineMetaSupport {

    public static final Logger logger = Logger.getLogger(Output.class);

    public Output(){
    }
    private Output(Params params){
    }
    ...
    public void execute(ServiceRequest.ServiceStep step, DataExecutionContext con) {
        ...
        logger.info("statement [ output "+tags + " ]");
